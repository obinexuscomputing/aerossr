  ...
  <body>
    ...
    async handleRequest(req, res) {
        try {
            ...
            await ErrorHandler.ErrorHandler.handleErrorStatic(error instanceof Error ? error : new Error('Unknown error'), req, res, { logger: this.logger } // Pass logger to error handler
            );
        }
    }
