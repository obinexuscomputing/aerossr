...
class AeroSSR {
    ...
    constructor(options = {}) {
        ...
        this.config = {
            ...
            errorHandler: options.errorHandler || ErrorHandler.ErrorHandler.handleErrorStatic,
    ...
    async handleRequest(req, res) {
        try {
            ...
            const error = err;
            await ErrorHandler.ErrorHandler.handleErrorStatic(error, req, res, { logger: this.logger });
        }
    }
