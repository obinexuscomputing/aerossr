...
export declare class CookieManager {
     ...
     */
    setCookie(name: string, value: string, days: number, options?: CookieOptions): boolean;
    /**
     ...
     */
    deleteCookie(name: string, options?: Omit<CookieOptions, 'maxAge' | 'expires'>): boolean;
    /**
