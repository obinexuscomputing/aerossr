...
import { S as StaticFileMiddleware } from './StaticFileMiddleware-3a909d94.js';
import 'fs/promises';
import 'crypto';
import 'http';
import 'url';
...
var require$$4 = /*@__PURE__*/getAugmentedNamespace(_polyfillNode_util);
...
(function (module, exports) {
	...
	Command.prototype.executeSubCommand = function(argv, args, unknown) {
	  ...
	  if (browser$1.platform !== 'win32') {
	    if (isExplicitJS) {
	      ...
	      args = (browser$1.execArgv || []).concat(args);

	      proc = spawn(browser$1.argv[0], args, { stdio: 'inherit', customFds: [0, 1, 2] });
	    } else {
	...
	Command.prototype.outputHelp = function(cb) {
	  ...
	  browser$1.stdout.write(cb(this.helpInformation()));
	  this.emit('--help');
	};
