...
async function resolveDependencies(filePath, deps = new Set(), options = {}) {
    const { extensions = ['.js', '.ts', '.jsx', '.tsx'], maxDepth = 100, ignorePatterns = ['node_modules'], baseDir = process.cwd() } = options;
...
export { AeroSSR as A, Logger as L, _polyfillNode_util$1 as _, generateETag as a, generateBundle as b, createCache as c, browser$1 as d, generateErrorPage as g, handleError as h, injectMetaTags as i, minifyBundle as m, normalizeCorsOptions as n, promisify as p, resolveDependencies as r, setCorsHeaders as s };
//# sourceMappingURL=AeroSSR-78d66d5f.js.map
